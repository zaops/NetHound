/** 昵称 */
export const NICKNAME = 'TheoZhang'
...
/** 个人 Github 地址 */
export const GITHUB_PERSONAL_PAGE_LINK = 'https://github.com/zaops'

/** 网站代码 Github 地址 */
export const GITHUB_PAGE_LINK = 'https://github.com/zaops'

/** 个人 Twitter/X 地址 */
export const TWITTER_PERSONAL_PAGE_LINK = 'https://x.com/zzaops'
...
export const HOME_TPYE_ZH_TEXT = '👨🏻‍💻 一名运维开发工程师 。'

export const HOME_TPYE_EN_TEXT = '👨🏻‍💻 A DevOps Engineer .'

export const HOME_SLOGAN_TEXT = '我在这里分享技术心得，记录成长历程，致力于成为一名优秀的 DevOps 工程师。'
...
export const ABOUT_IDENTITY_TEXT = '是一名运维开发工程师 👨🏻‍💻、足球运动爱好者 ⛹🏻‍♂️'
...
export const ABOUT_LOCATION_NAME = '中国，北京市'
